...
/**
 * Composite {@link ModelStore} that delegates spec operations to {@link RedisSpecStore}
 * and state operations to {@link RedisStateStore}.
 */
public final class RedisModelStore implements ModelStore {

    private final RedisSpecStore  specStore;
    private final RedisStateStore stateStore;

    public RedisModelStore(RedisSpecStore specStore, RedisStateStore stateStore) {
