...
/**
 * Composite {@link ModelStore} that delegates spec operations to {@link MongoSpecStore}
 * and state operations to {@link MongoStateStore}.
 */
public final class MongoModelStore implements ModelStore {

    private final MongoSpecStore  specStore;
    private final MongoStateStore stateStore;

    public MongoModelStore(MongoSpecStore specStore, MongoStateStore stateStore) {
